...
- `ttb_crossed_guitars.png` — source artwork (AI-generated, transparent background)
...
To change the icon, replace `ttb_crossed_guitars.png` (keep a transparent
background; any size/aspect works) and re-run the script. It automatically recenters the art and scales it
